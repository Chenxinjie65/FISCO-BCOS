...
int main(int, const char* argv[])
{
    ...
    std::vector<byte> bHashStdResultVector = {0xde, 0xbe, 0x9f, 0xf9, 0x22, 0x75, 0xb8, 0xa1, 0x38,
        0x60, 0x48, 0x89, 0xc1, 0x8e, 0x5a, 0x4d, 0x6f, 0xdb, 0x70, 0xe5, 0x38, 0x7e, 0x57, 0x65,
    ...
    verifyResult = Verify(
        libPath, result.publicKey, SM2, hsm::sdfToHex(bHashStdResultVector), signResult.signature);
    ...
    const std::vector<byte> pkv = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba,
    ...
    std::vector<byte> pbIV = {0xeb, 0xee, 0xc5, 0x68, 0x58, 0xe6, 0x04, 0xd8, 0x32, 0x7b, 0x9b,
        0x3c, 0x10, 0xc9, 0x0c, 0xa7};
    std::vector<byte> pbPlainText = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc,
        0xba, 0x98, 0x76, 0x54, 0x32, 0x10, 0x29, 0xbe, 0xe1, 0xd6, 0x52, 0x49, 0xf1, 0xe9, 0xb3,
        0xdb, 0x87, 0x3e, 0x24, 0x0d, 0x06, 0x47};
    std::vector<byte> pbCipherText = {0x3f, 0x1e, 0x73, 0xc3, 0xdf, 0xd5, 0xa1, 0x32, 0x88, 0x2f,
        0xe6, 0x9d, 0x99, 0x6c, 0xde, 0x93, 0x54, 0x99, 0x09, 0x5d, 0xde, 0x68, 0x99, 0x5b, 0x4d,
        0x70, 0xf2, 0x30, 0x9f, 0x2e, 0xf1, 0xb7};
